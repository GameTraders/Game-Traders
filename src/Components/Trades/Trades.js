                    ...
                    {best.length > 0 ? best.map((el, i) => (
                        <div key={i} className="Trades_Card_Outer" >
                           ...
                           {el.games.map((el, i) => (
                               ...
                               <img className="Trades_Individual_Games"  src={el.cover_art} alt=""/>
                               <h6>Game Name</h6>
                               </div>
                           ))}
                           </div>
